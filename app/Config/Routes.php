...
$routes->group('', ['filter' => 'auth:Role,1'], function ($routes) {
	...
	$routes->match(['get', 'post'], 'users/users_management', 'Users::users_management');
});
...
$routes->group('', ['filter' => 'auth:Role,2'], function ($routes) {
	...
	$routes->match(['get', 'post'], 'examples/employees_management', 'Examples::employees_management');
	$routes->match(['get', 'post'], 'examples/orders_management', 'Examples::orders_management');
	$routes->match(['get', 'post'], 'examples/products_management', 'Examples::products_management');
	$routes->match(['get', 'post'], 'examples/employees_management', 'Examples::employees_management');
	$routes->match(['get', 'post'], 'examples/film_management', 'Examples::film_management');
});
